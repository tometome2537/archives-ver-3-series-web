...
//   if (qChannelId == null)
//     return NextResponse.json({ error: "channelId is null" });

//   const items = await getChannelDetail(qChannelId);
//   if (items == undefined)
//     return NextResponse.json({ error: "channel was not found" });
...
//       items[0].brandingSettings?.channel?.unsubscribedTrailer || null,
...
//       status: 200,
//       statusText: "channel already added.",
//     });
