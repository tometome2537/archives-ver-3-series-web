...
type Props = {
  setPlayerSize: React.Dispatch<React.SetStateAction<number>>;
  setIsLargePlayer: React.Dispatch<React.SetStateAction<boolean>>;
};

export const Navbar = ({ setPlayerSize, setIsLargePlayer }: Props) => {
